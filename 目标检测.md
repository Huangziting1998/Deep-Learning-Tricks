...
- **Freebis**：Mosaic / DropBlock / label smoothing / CIoU loss / CmBN / DropBlock / Mosaic / self-adversarial training / elinimate grid sentivity / multiple anchors for a single GT / 余弦退火 / 超参数优化 / random training shapes
- **Specials**：Mish激活函数 / CSP / SPP-block / SAM-block / PAN / DIoU-NMS 
...
- Mosaic  / 自适应锚框 / 自适应图片缩放  / Focus / PAN / SPP / CIoU
